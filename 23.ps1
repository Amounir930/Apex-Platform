...
$ExcludedFolders = @(
    ...
    "dist", "build", "coverage", "update", "bin", "obj", "docs"
    ".next", ".nest", "assets", "public", "uploads", ".github",
    "__pycache__", ".pytest_cache", "temp", "tmp", "logs", "out", ".output"
)

$AllowedExtensions = "\.(ts|js|html|css|scss|java|py|cs|cpp|h|sql|prisma|sh|yml|yaml|xml|razor|jsx|tsx|vue|go|rs|php|rb|kt|swift|m|scala|r|pl|lua|dockerfile|gitignore|json)$"
